...
const HeroSection = () => {
  return (
    <div className="w-full min-h-screen font-sans">
      ...
      >
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-8 md:pt-12 md:pb-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="z-10">
              ...
              <div className="flex flex-col gap-4 mb-6">
                <button className="w-full md:w-[289px] h-11 bg-[#231F20] text-white py-2 px-6 rounded font-medium">
                  BOOK YOUR APPOINTMENT
                </button>
                <div className="w-full md:w-[289px] text-white font-semibold text-lg">
            ...
            <div className="relative z-10">
              <div className="relative">
                ...
                />
                {/*
                  Badge positions use responsive classes.
                  For mobile (default), smaller sizes and adjusted positions (e.g., top-2, left-2).
                  For desktop (md: prefix), the positions match your provided design.
                */}
                {/* Badge 1: Doctors Globally */}
                <div
                  className="absolute bg-white text-black rounded-full flex flex-col items-center justify-center shadow-md z-20
                    top-2 left-2 w-20 h-10 md:top-[80px] md:left-0 md:w-44 md:h-16"
                >
                  <p className="font-poppins text-[#28AAE1] font-bold text-xs md:text-base">
                    300+
                  </p>
                  <p className="font-poppins text-[#231F20] text-[8px] md:text-sm font-semibold text-center">
                    Doctors Globally
                  </p>
                </div>
                {/* Badge 2: Clinics Globally */}
                <div
                  className="absolute z-20 flex flex-col items-center justify-center rounded-full shadow-md bg-[#1E232FE3] text-white
                    top-10 right-2 w-20 h-10 md:top-[210px] md:right-[-10px] md:w-44 md:h-14"
                >
                  <p className="font-poppins text-[#28AAE1] font-bold text-xs md:text-base">
                    200+
                  </p>
                  <p className="font-poppins text-white text-[8px] md:text-sm font-semibold text-center">
                    Clinics Globally
                  </p>
                </div>
                ...
                <div
                  className="absolute z-20 flex flex-col items-center justify-center rounded-full shadow-md bg-[#1E232FE3] text-white
                    bottom-10 left-2 w-20 h-10 md:top-[330px] md:left-[-50px] md:w-44 md:h-14"
                >
                  <p className="font-poppins text-[#0073AE] font-bold text-xs md:text-base">
                    150k+
                  </p>
                  <p className="font-poppins text-[8px] md:text-sm text-center">
                    Happy Patients
                  </p>
                </div>
                ...
                <div
                  className="absolute bg-white text-black rounded-full flex flex-col items-center justify-center shadow-md z-20
                    bottom-[220px] right-[50px] w-20 h-10 md:bottom-[120px] md:right-0 md:w-44 md:h-16"
                >
                  <p className="font-poppins text-[#28AAE1] font-bold text-xs md:text-base">
                    91%
                  </p>
                  <p className="font-poppins text-[8px] md:text-sm font-semibold text-center">
                    Success Rate
                  </p>
                </div>
